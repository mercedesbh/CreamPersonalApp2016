      ...
      var service = new google.maps.DistanceMatrixService();
        ...
        $("#calculate-route").submit(function(event) {
          ...
          calculateRoute($("#from").val(), $("#to").val());
                ...
                //  if ($("#entryType").val = ("task") && text.includes(data.results.parameters.months)) {
                ...
                // 	theCandidate: function() {
                // 		const instance = Template.instance();
                // 		return instance.state.get("candidate");
                // 		const c = instance.state.get("candidate");
                // 		return c;
                // 	},
                //   donations: function(){
                ...
                // 	"change .js-candidate": function(event,instance){
                // 		const c = instance.$(".js-candidate").val();
                // 		instance.state.set("candidate", c);
                // 	},
                // });
                //
                // Template.quiz23.events({
                // 	"click .js-reportDonation": function(event){
                // 		console.log("hey you clicked the button")
                // 		//Read values of input fields and store in values
                // 		const yourname = $(".js-yourname").val();
                // 		const youramount = $(".js-youramount").val();
                //     const yourcandidate = $(".js-candidate").val();
                // 		const donations =
                // 		{yourname:yourname, youramount:youramount, yourcandidate:yourcandidate}
                // 		console.dir(donations);
                // 		//Budget.insert(wallets)
                // 		Meteor.call("insertDonation", donations);
                // 	},
                // })
